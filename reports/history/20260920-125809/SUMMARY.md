...
- 生成时间：2026-09-20T12:57:17+08:00
...
|---|---|---|---|---|---|---|---|---|
| L1 | 协议与公共库 | core-proto | **INVALID** | 17 | 2/3 | 2 | 7(0) | 0 |
...
- **[L1] REPORT_ERROR**：contractDeviations[0].impact 非法：major
...
- 要求 L1, L5 按 §5 schema 重新生成回报（禁止用自由文本替代）
